...
y_train_1 = np.random.randint(2,size=(1,10000))
y_test_1 = np.random.randint(2,size=(1,10000))
...
#-----------------------
parameters = L_layer_model(x_train_1, y_train_1, layers_dims)

pred_train = predict(x_train_1, y_train_1, parameters)

pred_test = predict(x_test_1, y_test_1, parameters)
